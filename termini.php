        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
            ...
            <div class="col">
                ...
                <p>
                    ...
                    <strong>2.1</strong> TicketSud vende biglietti per eventi, concerti, spettacoli teatrali e sportivi
                    di terze parti
                    ("Eventi"). TicketSud non è il promotore o il responsabile dell'organizzazione degli Eventi, e non è
                    responsabile di alcuna cancellazione, ritardo, modifica o altra questione relativa agli Eventi
                    stessi.
                    <br><strong>2.2 </strong> L'acquisto di biglietti tramite TicketSud è soggetto alla disponibilità
                    dei
                    biglietti per
                    l'Evento desiderato.
                </p>
