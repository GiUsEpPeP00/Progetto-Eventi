                ...
                <div class="p-5 border border-dark rounded-5 m-2">
                    <div class="row">
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <p>
                                <u><strong>E' possibile</strong></u> pagare attraverso le carte di credito dei circuiti
                                Visa,
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <p>
                                ...
                                competenti indicando: Titolare dell'ordine, Numero d'ordine, Numero dei biglietti,
                                Intestatari
                                dei singoli biglietti, Artista, Data e luogo dell'evento, Data presunta dello
                                smarrimento/furto/danneggiamento.
                                Attenzione! La denuncia deve essere inoltrata al nostro servizio clienti entro e non oltre
                                48
                                ore lavorative prima della data dell'evento attraverso questo form, specificando id ordine
                                ed
                                evento.
                            </p>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <p>Prima dell'inizio delle vendite l'organizzatore potrà indicare il periodo in cui il servizio
                                di
                                ...
                                considerato valido tutto il periodo fino a data evento e non ci saranno limitazioni al
                                numero di
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <p>
                                ...
                                desiderata e apri il menu a tendina "Informazioni sull'Organizzatore" presente sotto il
                                bottone
                                Biglietti.
                            </p>
                        </div>
