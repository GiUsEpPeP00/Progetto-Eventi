                    ...
                    <div class="row align-items-center flex-row-reverse">
                        <div class="col-lg-6">
                            <div class="about-text go-to">
                                ...
                                <p> Siamo un <u><strong>team appassionato e dedicato</strong></u> alla creazione di
                                    ...
                                    Il nostro obiettivo principale è quello di fornire un servizio affidabile e di alta
                                    qualità
                                    per risolvere qualsiasi problema o domanda che possa sorgere durante l'utilizzo del
                                    nostro
                        ...
                        <div class="col-lg-6">
                            <div class="about-avatar">
                                <img src="https://www.comune.canosa.bt.it/sites/default/files/styles/medium/public/2018-02/comune.jpg?itok=GTV3iTRo"
                                    alt="">
                            </div>
                        </div>
